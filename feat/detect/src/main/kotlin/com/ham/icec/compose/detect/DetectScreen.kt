...
//                    val rectangles = sideEffect.rectangles.map { rectangle ->
//                        Rect(
//                            rectangle.left,
//                            rectangle.top,
//                            rectangle.right,
...
//                        )
//                    }
//                    val drewBitmap = drawBoundingBoxesOnImage(originalImage, rectangles)
//
//                    withContext(Dispatchers.Main) {
//                        centerImage = drewBitmap
//                    }
                }
            }
        }
    ...
    Box {
        Column(
            ...
            CenterImageFrame {
                CenterImage(
                    image = centerImage,
                    boundingBoxes = detectedFaces.map { it.face.boundingBox }.toImmutableList()
                )
//                CoilImage(
//                    modifier = Modifier.fillMaxSize(),
